...
.article-item {
	...
	border-radius: 8px;
	padding: 16px;
	margin: 0 auto; /* 将元素水平居中显示 */
	margin-bottom: 16px;
	display: flex;
	flex-direction: column;
	background-color: #f9f9f9; /* 设置背景颜色 */
	margin-right: 20%; /* 向右移动20% */
}
														...
														.each(
																...
																function(index,
																	...
																	var row = '<div class="article-item">'
																			...
																			+ '<button class="btn btn-primary btn-sm editButton" type="submit">修改</button>'
																			+ '</form>'
																			...
																			+ '<button class="btn btn-danger btn-sm deleteButton" type="submit">刪除</button>'
																			+ '</form>'
