	...
	<div class="main">
		<div class="back-content">
			...
			<div style="float: right; ">
					...
					<button class="insertbtn" type="submit" style="margin-bottom: 10px; background-color: #0DCAF0; font-size: 20px; border-radius: 15px;">
						<i class="fa-brands fa-discourse"></i>發布文章
					</button>


				<form method="get" action="/html/LTTitleFront.html"
			...
			<div class="youtube-video"
				style="position: fixed; top: 50%; transform: translateY(-50%); left: 0;">
			...
			<div>
				<div class="col-auto ml-auto mx-auto">
					<div class="mx-auto" style="width: 120px;">
						<input type="number" id="pageNumberInput" class="form-control"
							placeholder="跳轉頁碼" style="width: 120px;">
			...
			<div class="col-auto ml-auto mx-auto">
				...
				<div class="pagination-container">
					<ul class="pagination justify-content-end m-3">
						<li class="page-item" id="firstPage"><a class="page-link"
							href="#">«</a></li>
						<li class="page-item" id="prevPage"><a class="page-link"
							href="#">‹</a></li>
						<li class="page-item" id="TTTTT"><a class="page-link"
							href="#">›</a></li>
...
// 									}
	...
	<script>
		// 使用Ajax發送HTTP請求到後端檢查使用者是否收藏過該文章
							...
							$.ajax({ 
								...
								success : function(response) {
									...
									if(userID==""){
 										...
 										window.location.href="/html/LTInsertFront.htm";
 									}
								},
								error : function(xhr, status, error) {
									console.error(error);
...
<!-- 寫一個 ajax 再寫一個點擊事件的function 把from表單拔掉 -->
