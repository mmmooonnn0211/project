	...
	<div class="main">
		<div class="back-content">
			...
			<div style="float: right; ">
				...
				<button class="insertbtn" type="submit"
					style="margin-bottom: 10px; background-color: #0DCAF0; font-size: 20px; border-radius: 15px;">
					<i class="fa-brands fa-discourse"></i>發布文章
				</button>


				<form method="get" action="/html/LTTitleFront.html" style="margin-bottom: 10px; font-size: 20px;">
				...
				<form method="Get" action="html/LTSelectFront.html">
					<button style="background-color: #0DCAF0; font-size: 20px; border-radius: 15px;" type="submit">
		...
		<div class="youtube-video" style="position: fixed; top: 50%; transform: translateY(-50%); left: 0;">
			<iframe width="350" height="350"
				src="https://www.youtube.com/embed/FWCIocUWpFw?si=kWqi-GvBApZNLfsy?mute=1&autoplay=1" frameborder="0"
