				...
				<c:forEach items="${ltBeans}" var="items">
					<div class="article-item">
						...
						<div class="article-actions">
							...
							<form method="post" action="/ReportinsertFront.controller"
							...
							<form method="Get"
								action="/LTSelectByIdFront.controller/${items.ltId}">
								<button class="btn btn-primary btn-sm" type="submit"
									style="background-color: blue">修改</button>
							</form>

							<form method="post"
								action="/LTDeleteByIdFront.controller?ltId=${items.ltId}">
								<input type="hidden" name="_method" value="DELETE">
								<button class="btn btn-danger btn-sm delete" type="submit"
									style="background-color: blue" required>刪除</button>
							</form>
							...
							<form method="POST" action="/LikeinsertFront.controller">
								...
								<span class="like-count">${items.saveLike}</span>
								<!-- 顯示讚數 -->
							</form>
						</div>
						<div></div>
